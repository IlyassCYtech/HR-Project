    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <div class="user-info">
                ...
                <h6>${utilisateur.username != null ? utilisateur.username : 'Utilisateur'}</h6>
            ...
            <nav>
                ...
                <c:if test="${utilisateur.role eq 'ADMIN' or utilisateur.role eq 'RH' or utilisateur.role eq 'CHEF_DEPT'}">
