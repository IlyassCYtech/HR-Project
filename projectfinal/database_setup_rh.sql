-- Script de création de la base de données pour le système de gestion RH
-- À exécuter avec MySQL Workbench
...
CREATE TABLE IF NOT EXISTS Notification(
	...
	type ENUM('INFO','ALERTE','ERROR') DEFAULT 'INFO',
...
CREATE TABLE IF NOT EXISTS Notification_user(
	...
	UNIQUE KEY uq_notification_user(notification_id, utilisateur_id),
	CONSTRAINT fk_notification_user_notification
		FOREIGN KEY (notification_id) REFERENCES notification(id) ON DELETE CASCADE,
	CONSTRAINT fk_notification_user_utilisateur
...
-- Hash BCrypt $2a$ (compatible avec jBCrypt Java)
-- admin / admin123
-- marie.dubois / marie123  
-- pierre.leroy / pierre123
-- sophie.bernard / sophie123
-- paul.rousseau / paul123
-- claire.durand / claire123
-- luc.moreau / password123
INSERT INTO utilisateurs (username, password_hash, email, role, employe_id) VALUES
('admin', '$2a$10$.3WVbWIB6yfk.lI8SQUOp.6iDjLEfp/kea/P8kzfqOtmT3fvo3pDm', 'admin@entreprise.com', 'ADMIN', 1),
('marie.dubois', '$2a$10$SnENV.qAxIXf/KgZzdjeX.SRvd7uXHUcHUEID9q/LYsbB7IEB4SIW', 'marie.dubois@entreprise.com', 'RH', 2),
('pierre.leroy', '$2a$10$GH5bP1.u/EQLHz.I8pjU/.jI5nPoDMF4gvJ2znDiCTaiiYdAv3msa', 'pierre.leroy@entreprise.com', 'CHEF_PROJET', 3),
('sophie.bernard', '$2a$10$QyFmzYTmyxCn.52EoFuULeVhf3S0jQcyJ8xIWlKbnly22Uh1cMD/a', 'sophie.bernard@entreprise.com', 'CHEF_DEPT', 4),
('paul.rousseau', '$2a$10$nI4ZGoMp1UPcTY1gArmUjefH4t9XXFJ1y5latRrjsNDJ8peDD5LSC', 'paul.rousseau@entreprise.com', 'CHEF_DEPT', 5),
('claire.durand', '$2a$10$0t2IjLyPfF2PgRAXXaBJkOFd3pVK69iGhklfufqhNRPOfeETJQyIG', 'claire.durand@entreprise.com', 'EMPLOYE', 6),
('luc.moreau', '$2a$10$RMdmqXrPaCKV57C6QnyrJ.seU5gGzkbW2Diq8RtUNG6vJVzm8fQwO', 'luc.moreau@entreprise.com', 'EMPLOYE', 7);
...
VALUES ('Test notification pour admin', 'INFO');
INSERT INTO notification_user (notification_id, utilisateur_id, est_lu)
VALUES (1, 1, 0);
