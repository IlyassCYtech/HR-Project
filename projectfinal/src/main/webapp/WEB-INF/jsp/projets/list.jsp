                    ...
                    <c:forEach var="projet" items="${projets}">
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <span style="display: inline-flex; align-items: center; justify-content: center; min-width: 36px; height: 36px; background: #F5F5F5; border-radius: 8px; font-weight: 600; color: #1A1A1A;" title="${projet.nombreEmployes} membre(s) dans l'équipe">
                                    <i class="fas fa-users" style="margin-right: 6px; color: #C5A572; font-size: 14px;"></i>
                                    ${projet.nombreEmployes}
                                </span>
                            </td>
                            <td style="text-align: center;">
                                <c:choose>
                            ...
                            <td style="text-align: center;">
                                <div style="display: inline-flex; gap: 8px;">
                                    ...
                                    <%-- 
                                        ...
                                        - CHEF_PROJET : NE PEUT MODIFIER AUCUN PROJET
                                        - EMPLOYE : ne peut pas modifier
                                    --%>
                                    <c:choose>
                                        ...
                                        <%-- CHEF_DEPT : uniquement les projets de son département --%>
                                        <c:when test="${utilisateur.role eq 'CHEF_DEPT' and 
                                                        not empty utilisateur.employe and 
                                                        not empty utilisateur.employe.departement and 
                                                        not empty projet.departement and 
                                                        utilisateur.employe.departement.id eq projet.departement.id}">
                                            <a href="${pageContext.request.contextPath}/app/projets?action=edit&id=${projet.id}" 
                                               class="btn btn-secondary btn-sm" title="Modifier">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        </c:when>
                                        <%-- CHEF_PROJET et EMPLOYE : pas de bouton modifier --%>
                                    </c:choose>
