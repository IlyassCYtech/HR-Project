...
public class DepartementService {
    ...
    public java.util.Map<String, Long> getEmployeeCountsMap() {
    ...
    public void affecterEmploye(Long departementId, Long employeId) {
        departementRepository.affecterEmployeAuDepartement(departementId, employeId);
    }
    
    public void retirerEmploye(Long departementId, Long employeId) {
        departementRepository.retirerEmployeDuDepartement(departementId, employeId);
    }
}
