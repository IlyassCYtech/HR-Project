    ...
    public String listEmployes(
        ...
        employes = employes.stream()
            .filter(e -> {
                ...
                if (departement != null) {
                    boolean matchDept = e.getDepartement() != null && e.getDepartement().getId().equals(departement);
        ...
        // Ajouter l'ID de l'employé connecté pour permettre la modification de son propre profil
