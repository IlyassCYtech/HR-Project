...
public class CongeViewController {
    ...
    public String listConges(
        ...
        model.addAttribute("page", "conges");
        return "conges/list";
    }
    ...
    @PostMapping("/create")
    public String createConge(@ModelAttribute CongeAbsence conge, Authentication authentication, RedirectAttributes redirectAttributes) {
        try {
            ...
            if (conge.getEmploye() != null && conge.getEmploye().getId() != null) {
                ...
                if (isAdminOrRH) {
                    ...
                    if (utilisateur.getEmploye() != null) {
                        ...
                        redirectAttributes.addFlashAttribute("error", "Vous devez être lié à un employé pour créer une demande");
    ...
    public String updateConge(@PathVariable Long id, @ModelAttribute CongeAbsence conge, RedirectAttributes redirectAttributes) {
        try {
