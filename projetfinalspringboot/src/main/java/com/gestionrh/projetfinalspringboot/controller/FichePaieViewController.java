...
public class FichePaieViewController {
    ...
    /**
     * Télécharger toutes les fiches de paie d'un employé par nom d'utilisateur ou ID
    ...
    public void downloadEmployeeFichesZipByIdentifier(@PathVariable String identifier, HttpServletResponse response) {
        try {
            ...
            // *** RESTRICTION : Si ni RH ni ADMIN ni CHEF_DEPT, vérifier que c'est ses propres fiches ***
            if (utilisateur.getRole() != Role.RH && 
                ...
                if (utilisateur.getEmploye() == null || 
                    ...
                    response.sendError(HttpServletResponse.SC_FORBIDDEN, "Accès refusé : vous ne pouvez télécharger que vos propres fiches");
                    return;
                }
            }
